...
function demo16(game, world) {
    ...
    world.register(b);
    let j = new MaxDistanceJoint(c, b, 2, undefined, undefined, 0.7, 0.1);
    world.register(j, true);
...
function demo20(game, world) {
    ...
    let c1;
    {
        ...
        c1.position.y = 1.5;
        world.register(c1);
        let j = new RevoluteJoint(ground, c1, c1.position);
        j.drawAnchor = false;
        j.drawConnectionLine = false;
        world.register(j);
    ...
    let c2;
    {
        ...
        world.register(c2);
        let j = new RevoluteJoint(ground, c2, c2.position);
        j.drawConnectionLine = false;
        world.register(j);
